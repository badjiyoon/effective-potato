...
Login Process
    ...
    Execute JavaScript           dst_input.setCellData(0, "login_id", "9004KEO");
...
Move Frame Process
    ...
    Execute Javascript           wfm_findLayer_edt_keyword.setValue("Home고객센터 고객상담");
    Click Element                id=wfm_findLayer_btn_findBtn
    #Execute Javascript           wfm_findLayer_grd_serachResult_cell_0_0.click();
    
Move Frame Process1
    #set selenium implicit wait   10 seconds
    Click Element                id=mdi01ZOSSSCOM22190_refresh
	#set selenium implicit wait   10 seconds  
    
*** Test Cases ***
[TEST-002] 003_ZOSSSCOMS3010(Home고객센터 고객상담) SKT Swing TestCase Runnable
    Init W-Browser
    Make Har
    Login Process
	Move Frame Process
