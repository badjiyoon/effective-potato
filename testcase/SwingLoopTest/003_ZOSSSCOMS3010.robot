...
Move Frame Process
    ...
    Execute Javascript           wfm_findLayer_edt_keyword.setValue("통합스케쥴러 작업관리");
    Click Element                id=wfm_findLayer_btn_findBtn
    #Execute Javascript           wfm_findLayer_grd_serachResult_cell_0_0.click();
    
Move Frame Process1
    #set selenium implicit wait   10 seconds
    Click Element                id=mdi01ZOSSSCOMS3010_refresh
	#set selenium implicit wait   10 seconds  
    
*** Test Cases ***
[TEST-002] 003_ZOSSSCOMS3010(통합스케쥴러 작업관리) SKT Swing TestCase Runnable
    Init W-Browser
    Make Har
    Login Process
	Move Frame Process
