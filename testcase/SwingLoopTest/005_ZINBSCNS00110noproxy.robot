...
Move Frame Process
	...
	Execute Javascript           wfm_findLayer_grd_serachResult_cell_2_0.click();
    
Move Frame Process1
    set selenium implicit wait   10 seconds
	Select Frame                 mdi01_subWindow1_iframe
    Execute Javascript           input_udc_edt_svc_num.setValue("01091793560");
    Execute Javascript           btn_Search.click();
    Execute Javascript           ngmf.promise.dialog("CCA", "ZNGMSCAP20010");
    set selenium implicit wait   10 seconds
    set selenium implicit wait   10 seconds
    set selenium implicit wait   10 seconds
