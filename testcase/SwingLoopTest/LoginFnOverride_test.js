...
//scvar.getPerformanceData = function() {
	//return "AAAAAAAAA\t" + "\t" 
		//	+ ( ngmf.getWindow(scvar.G_ACTIVE_FORMID).WebSquare.BootLoader.performanceCheck.mid1.getTime() 
		//	-  ngmf.getWindow(scvar.G_ACTIVE_FORMID).WebSquare.BootLoader.performanceCheck.start.getTime()) + "\t" 
		//	+ ( ngmf.getWindow(scvar.G_ACTIVE_FORMID).WebSquare.BootLoader.performanceCheck.mid2.getTime() 
		//	-  ngmf.getWindow(scvar.G_ACTIVE_FORMID).WebSquare.BootLoader.performanceCheck.mid1.getTime()) + "\t"
		//	+ "\t" + ( ngmf.getWindow(scvar.G_ACTIVE_FORMID).WebSquare.BootLoader.performanceCheck.mid3.getTime() 
		//	-  ngmf.getWindow(scvar.G_ACTIVE_FORMID).WebSquare.BootLoader.performanceCheck.mid2.getTime()) + "\t" 
		//	+ ( ngmf.getWindow(scvar.G_ACTIVE_FORMID).WebSquare.BootLoader.performanceCheck.mid4.getTime() 
		//	-  ngmf.getWindow(scvar.G_ACTIVE_FORMID).WebSquare.BootLoader.performanceCheck.mid3.getTime()) + "\t" 
		//	+ ( ngmf.getWindow(scvar.G_ACTIVE_FORMID).WebSquare.BootLoader.performanceCheck.mid5.getTime() 
		//	-  ngmf.getWindow(scvar.G_ACTIVE_FORMID).WebSquare.BootLoader.performanceCheck.mid4.getTime()) + "\t" 
		//	+ ( ngmf.getWindow(scvar.G_ACTIVE_FORMID).WebSquare.BootLoader.performanceCheck.mid6.getTime() 
		//	-  ngmf.getWindow(scvar.G_ACTIVE_FORMID).WebSquare.BootLoader.performanceCheck.mid5.getTime()) + "\t" 
		//	+ ( ngmf.getWindow(scvar.G_ACTIVE_FORMID).WebSquare.BootLoader.performanceCheck.end.getTime() 
		//	-  ngmf.getWindow(scvar.G_ACTIVE_FORMID).WebSquare.BootLoader.performanceCheck.mid6.getTime()) + "\t" 
		//	+ ( ngmf.getWindow(scvar.G_ACTIVE_FORMID).WebSquare.BootLoader.performanceCheck.end.getTime() 
		//	-  ngmf.getWindow(scvar.G_ACTIVE_FORMID).WebSquare.BootLoader.performanceCheck.start.getTime()) + "\tAAAAAAAAA" + ngmf.getWindow(scvar.G_ACTIVE_FORMID).WebSquare.w2xPath;
//}